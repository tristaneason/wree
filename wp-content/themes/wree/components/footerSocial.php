    ...
    <div class="container">
        <div class="flex align-center space-between">
            <div id="footerSocialLeft" class="flex align-center">
                <span class="title">Women for Racial and Economic Equality, USA</span>
            ...
            <div id="footerSocialRight" class="flex align-center invisible">
                ...
                <span>
                    <a href="https://twitter.com/wreeusa" target="_blank">
                        <i class="fab fa-twitter-square fa-2x"></i>
                    </a>
                </span>
                <span>
                    <a href="https://www.instagram.com/wreeusa/" target="_blank">
