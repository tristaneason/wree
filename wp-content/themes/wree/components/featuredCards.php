...
<section id="featuredCards" class="">
    <div class="container grid halves">
        <div class="card grid two-thirds">
            <div id="featuredPost1" class="flex column">
                <span class="category"><?= get_the_category($id_1)[0]->name; ?></span>
                <a href="<?= get_permalink($id_1); ?>">
                    <h2 class="title"><?= get_the_title($id_1); ?></h2>
                </a>
                <span class="date"><?= $date_1; ?></span>
                <p class="excerpt"><?= get_the_excerpt($id_1); ?></p>
            </div>
            <a
                href="<?= get_permalink($id_1); ?>"
                class="thumbnail display-none-mobile"
                style="background-image: url('<?= get_the_post_thumbnail_url($id_1); ?>');">
            </a>
        </div>
        <div id="featuredPost2" class="card grid two-thirds">
            <div class="flex column">
                ...
                <a href="<?= get_permalink($id_2); ?>">
                    <h2 class="title"><?= get_the_title($id_2); ?></h2>
                </a>
                <span class="date"><?= $date_2; ?></span>
                <p class="excerpt"><?= get_the_excerpt($id_2); ?></p>
            </div>
            <a
                href="<?= get_permalink($id_2); ?>"
                class="thumbnail display-none-mobile"
                style="background-image: url('<?= get_the_post_thumbnail_url($id_2); ?>');">
            </a>
        </div>
    </div>
</section>
